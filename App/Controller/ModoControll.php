...
if (isset($_POST['gravar'])) {
    ...
    if (empty($d['descricao'])) {
        header('Location: ../../App/Views/cadastros/ItemModo.php?msg=1');
    }
...
//    $c->setProdutoId($d['produto']);
    ...
    $cdao->Inserir($c);
     header('Location: ../../App/Views/cadastros/ItemModo.php');
}
...
if ($deletar != null) {
    ...
    if ($teste->getId() == '0') {
        ...
        echo 'deu ruim';
        header("Location: ../../App/Views/cadastros/ItemModo.php?msg=2");
    }
}

...
$c = new ItemCorrenteFuga();
$cdao = new ItemCorrenteDAO();

if (isset($_POST['gravar'])) {

    if (empty($d['produto']) || empty($d['descricao'])) {
        header('Location: ../../App/Views/cadastros/ItemCorrentedeFuga.php?msg=1');
    }
    ...
    $cdao->Inserir($c);
     header('Location: ../../App/Views/cadastros/ItemCorrentedeFuga.php');
}
...
if ($deletar != null) {
    ...
    if ($teste->getId() == '0') {
        ...
        echo 'deu ruim';
        header("Location: ../../App/Views/cadastros/ItemCorrentedeFuga.php?msg=2");
    }
}

...
$c = new ItemLiberacao();
$cdao = new ItemLiberacaoDAO();

if (isset($_POST['gravar'])) {

    if (empty($d['produto']) || empty($d['descricao'])) {
        header('Location: ../../App/Views/cadastros/ItemLiberacao.php?msg=1');
    }
    ...
    $cdao->Inserir($c);
     header('Location: ../../App/Views/cadastros/ItemLiberacao.php');
}
...
if ($deletar != null) {
    ...
    if ($teste->getId() == '0') {
        ...
        echo 'deu ruim';
        header("Location: ../../App/Views/cadastros/ItemLiberacao.php?msg=2");
    }
}

...
if (isset($_POST['gravar'])) {
    ...
    if (empty($descricao)) {
        header("Location: ../../App/Views/cadastros/tipoDocumento.php?msg=1");
    } else {
        ...
        header("Location: ../../App/Views/cadastros/tipoDocumento.php");
    }
}
...
if ($deletar != null) {
    ...
    if ($teste->getId() == '0') {
        ...
        header("Location: ../../App/Views/cadastros/tipoDocumento.php?msg=2");
    }
}

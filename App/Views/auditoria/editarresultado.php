                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-default">
                                                        ...
                                                        <?php } if ($count == null) {
                                                            ?>
                                                            <div class='col-md-12'>
                                                                <label  style="background-color: yellow">Não Possui Itens Não Conforme</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea rows="3" name="sugestao" class="form-control"><?= strip_tags($dados->getSugestao()) ?></textarea>
                                                        </div>                                       
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label>Conclusão</label>
                                                            <textarea rows="3" name="conclusao" class="form-control"><?= strip_tags($dados->getConclusao()) ?></textarea>
                                                        </div>                                       
                                                    </div>
                                                </div>                                       
                                            </div>

                                            <button type="submit" name="editarresultado" class="btn btn-primary"> Gravar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>

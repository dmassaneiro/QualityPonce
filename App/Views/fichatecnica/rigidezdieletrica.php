                ...
                <div class="col-xs-12 col-sm-9 content">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="POST" action="../../Controller/fichaEnsaioRigidezControll.php">
                                <div class="content-row">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <?php foreach ($irdao->BuscarTodosDoProduto($dados->getProdutoId()) as $idmodo) { ?>
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <label><br></label>
                                                        <input class="form-control" title="" readonly="" type="text" value="<?= $idmodo->getDescricao() ?>">
                                            ...
                                            <div class="btn-group dropup">
                                                <button class="btn btn-primary" type="submit" name="regidez">Corrente de Fuga</button>
                                            </div>  
                                            <div class="btn-group dropup">
                                                <button class="btn btn-success" type="submit" name="regidez-sair">Gravar e Sair</button>
                                            </div>  
                                        </div>

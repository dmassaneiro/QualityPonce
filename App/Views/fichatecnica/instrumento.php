                ...
                <div class="col-xs-12 col-sm-9 content">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form method="POST" action="../../Controller/fichaInstrumentoControll.php">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="btn-group dropup">
                                                <button class="btn btn-primary" type="submit" name="instrumentos">Liberação</button>
                                            </div>  
                                            <div class="btn-group dropup">
                                                <button class="btn btn-success" type="submit" name="instrumentos-sair">Gravar e Sair</button>
                                            </div> 
                                        </div>
                                    </div>
                                </div>

...
//                                                $ii = new ItemCorrenteDAO()
                                                foreach ($t->BuscarTodosdaFicha($dados->getId(), $idcorrente->getId()) as $idmodo) {
                                                    $nm_corrente = $t->BuscarNomedaCorrente($idmodo->getItemCorrenteFugaId());
                                                    $count = $idmodo->getItemCorrenteFugaId();
                                                    if ($count != null) {
                                                        ?>
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                <label>Modo</label>
                                                                <input type="text" readonly=""  class="form-control"  value="<?= $nm_corrente->getDescricao() ?>">
                                                                <input type="hidden" name="idcorrente<?= $idcorrente->getId() ?>[]" value="<?= $idmodo->getItemCorrenteFugaId() ?>">
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label>Data</label>
                                                                <input type="date" name="data<?= $idcorrente->getId() ?>[]" class="form-control"  value="<?= $idmodo->getData() ?>">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Valor CA (uA)</label>
                                                                <input type="text" id="sonumero" name="valorca<?= $idcorrente->getId() ?>[]" class="form-control somente-numero" value="<?= $idmodo->getValorCa() ?>">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Valor CC (uA)</label>
                                                                <input type="text" id="sonumero" name="valorcc<?= $idcorrente->getId() ?>[]" class="form-control somente-numero" value="<?= $idmodo->getValorCc() ?>">
                                                            </div>
                                                            <div class="col-md-3">
                                            ...
                                            <div class="btn-group dropup">
                                                <button class="btn btn-primary" type="submit" name="corrente-edit">Testes Funcionais</button>
                                            </div>  
                                            <div class="btn-group dropup">
                                                <button class="btn btn-warning" type="submit" name="corrente-edit-sair">Editar e Sair</button>
                                            </div> 
                                        </div>
                                    </div>
                                </div>

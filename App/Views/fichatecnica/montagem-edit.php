                                ...
                                <div class="content-row">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <?php
                                            $count = 0;
                                            foreach ($mdao->BuscarTodosdaFicha($dados->getId()) as $idmodo) {
                                                ...
                                                if ($count != null) {
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-9">
                                                            <label><br></label>
                                                            <input class="form-control" title="ITEM DO QUESTIONÁRIO" readonly="" type="text" value="<?= $nm_montagem->getDescricao() ?>">
                                                            <input type="hidden" name="iditemmontagem[]" value="<?= $idmodo->getItemMontagemId() ?>">
                                                        </div>
                                                        <div class="col-md-3">
                                            ...
                                            <div class="btn-group dropup">
                                                <button class="btn btn-primary" type="submit" name="itemmontagem-edit">Rigidez Dielétrica</button>
                                            </div>  
                                            <div class="btn-group dropup">
                                                <button class="btn btn-warning" type="submit" name="itemmontagem-edit-sair">Editar e Sair</button>
                                            </div> 
                                        </div>
                                    </div>
                                </div>

                ...
                <div class="col-xs-12 col-sm-9 content">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Esconder Menu"></span></a> Montagem</h3>
                        </div>
                        <div class="panel-body">
                            <div class="content-row">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 class="content-row-title">Montagem Cadastradas</h2>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="modal-dialog" >
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <center><h4 class="modal-title">Cadastro de Montagem</h4></center>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="../../Controller/MontagemControll.php" method="POST">
                                                            <div class="col-md-12">
                                                        ...
                                                        <div class="modal fade" id="edit<?= $d->getId() ?>" role="dialog">
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                        <center><h4 class="modal-title">Editar Montagem</h4></center>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form action="../../Controller/MontagemControll.php" method="POST">
                                                                            <div class="col-md-12">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <center>
                                                                        ...
                                                                        <a href="../../Controller/MontagemControll.php?deletar=<?= $d->getId() ?>"<button class="btn btn-success">SIM</button></a>

                ...
                <div class="col-xs-12 col-sm-9 content">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Esconder Menu"></span></a> Setor</h3>
                        </div>
                        <div class="panel-body">
                            <div class="content-row">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 class="content-row-title">Setores Cadastradas</h2>
                                        <div class="row">
                                            <div class="col-md-2">
                                        ...
                                        <div class="modal fade" id="add" role="dialog">
                                            <div class="modal-dialog" >
                                                <!-- Modal content-->
                                                <form name="forme" action="../../Controller/SetorControll.php" method="POST">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            <center><h4 class="modal-title">Cadastro de Setor</h4></center>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $resultado = $setorDao->BuscarTodosSetores();
                                                    if ($pesquisa != '') {
                                                        $resultado = $setorDao->BuscarTodosSetoresDescricao($pesquisa);
                                                    }
                                                    foreach ( $resultado as $nc) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#edit<?= $nc->getId() ?>" style=" float:left; margin: 0 4px 0 0;"><i class="glyphicon glyphicon-edit"></i> </button>
                                                                <a href="../../Controller/SetorControll.php?del=<?= $nc->getId() ?>">
                                                    ...
                                                    <div class="modal fade" id="edit<?= $nc->getId() ?>" role="dialog">
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="../../Controller/SetorControll.php" method="POST">
                                                                    <div class="modal-body">

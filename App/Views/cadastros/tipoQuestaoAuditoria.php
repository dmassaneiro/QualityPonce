...
<html>
    <head>
        <title>Tipo de Questão da Auditoria</title>
                ...
                <div class="col-xs-12 col-sm-9 content">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Esconder Menu"></span></a> Tipo Questão Auditoria</h3>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="modal fade" id="add" role="dialog">
                                            <div class="modal-dialog" >
                                                <!-- Modal content-->
                                                <form name="forme" action="../../Controller/TipoQuestaoControll.php" method="POST">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            <center><h4 class="modal-title">Cadastro de Origem Tipo de Questão</h4></center>
                                                        </div>
                                                        ...
                                                        foreach ($resultado as $nc) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#edit<?= $nc->getId() ?>" style=" float:left; margin: 0 4px 0 0;"><i class="glyphicon glyphicon-edit"></i> </button>
                                                                    <a href="../../Controller/TipoQuestaoControll.php?del=<?= $nc->getId() ?>">
                                                        ...
                                                        <div class="modal fade" id="edit<?= $nc->getId() ?>" role="dialog">
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                        <center><h4 class="modal-title">Editar Tipo Questões</h4></center>
                                                                    </div>
                                                                    <form action="../../Controller/TipoQuestaoControll.php" method="POST">
                                                                        <div class="modal-body">
